...
public final class FragmentInfoBinding implements ViewBinding {
  ...
  private FragmentInfoBinding(@NonNull ConstraintLayout rootView, @NonNull TextView textView) {
  ...
  public static FragmentInfoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentInfoBinding((ConstraintLayout) rootView, textView);
    }
