...
public final class FragmentInicioBinding implements ViewBinding {
  ...
  private FragmentInicioBinding(@NonNull ConstraintLayout rootView, @NonNull Button btnComenzar) {
  ...
  public static FragmentInicioBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentInicioBinding((ConstraintLayout) rootView, btnComenzar);
    }
